...
import styles from "./track-request-id.module.scss";
import { useRouter } from "next/navigation";
import { useTranslations } from "next-intl";
import Image from "next/image";

export default function TrackRequestIdComponent({ locale}) {
              ...
              <div className={styles.mainGrid}>
                ...
                <div>
                  ...
                  <div className={styles.twoColGrid}>
                    ...
                    >
                      <div className={styles.activityDetailsAlignment}  onClick={()=>redirect.push(`/${locale}/track-request-detail`)}>
